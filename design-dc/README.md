...
| `excalidraw-artifacts` | Convert an HTML artifact into a locked-background Excalidraw canvas for live talk markup, then read the annotations back out and correlate them with the document. Ships two zero-dependency scripts (Chrome-over-CDP render; sidecar-based readback). |
